...
set "zipFile=Modern Picker.zip"
set "extractPath=Modern Picker"
...
start "" "%cd%\Modern Picker\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Modern Picker.
